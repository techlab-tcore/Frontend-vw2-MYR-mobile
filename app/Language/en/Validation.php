...
return [
    ...
    'casinogamerulescontent' => '<p class="text-start fs-6">Our company hereby solemnly declares that if any player is found to be involved in <b>Blackjack</b> or <b>Baccarat Perfect Pair games</b> while participating in the entertainment services provided by our company, our company will take the following measures:</b> <p class="text-start fs-6">Winnings will not be paid out.</p><p class="text-start fs-6">All winnings from Blackjack and Baccarat Perfect Pair games will not be paid out or settled.</p><p class="text-start fs-6">Proceeds will be confiscated.</p><p class="text-start fs-6">Our company will confiscate all winnings from the player in the game, including principal, bonuses, and related prizes.</p>',
