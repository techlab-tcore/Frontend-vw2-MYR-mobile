<div class="container">
    ...
    <dl class="row">
        ...
        -->
        <dd class="col-xl-12 col-lg-12 col-md-12 col-12 d-none d-sm-block">
            ...
            <div class="card border-0 profileRight">
                <div class="card-body p-xl-5 p-lg-5 p-md-5 p-3">
                    <nav class="nav nav-tabs">
                        <a class="nav-link bg-gradient active" href="#" data-bs-toggle="pill" data-bs-target="#pass-login"><?=lang('Nav.loginpass');?></a>
                        <a class="nav-link bg-gradient" href="#" data-bs-toggle="pill" data-bs-target="#pass-secondary"><?=lang('Nav.secondpass');?></a>
                        <a class="nav-link bg-gradient" href="#" data-bs-toggle="pill" data-bs-target="#resetpass-secondary"><?=lang('Nav.resetsecondpass');?></a>
                    </nav>
                    <article class="tab-content">
                        <section class="tab-pane fade p-xl-5 p-lg-5 p-md-3 p-3 show active" id="pass-login">
                            <?=form_open('',['class'=>'form-validation customForm chgPassForm','novalidate'=>'novalidate']);?>
                            <div class="row mb-3">
                                <label class="col-xl-3 col-lg-3 col-md-3 col-12 col-form-label text-dark position-relative required2"><?=lang('Input.currentpass');?></label>
                                <div class="col-xl-9 col-lg-9 col-md-9 col-12">
                                    <input type="text" class="form-control" pattern=".{6,}" name="currentpass" required>
                                    <small class="invalid-feedback"><?=lang('Validation.password',[6]);?></small>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-xl-3 col-lg-3 col-md-3 col-12 col-form-label text-dark position-relative required2"><?=lang('Input.newpass');?></label>
                                <div class="col-xl-9 col-lg-9 col-md-9 col-12">
                                    <input type="text" class="form-control" pattern=".{6,}" id="newpass" name="newpass" required>
                                    <small class="invalid-feedback"><?=lang('Validation.newpass',[6]);?></small>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-xl-3 col-lg-3 col-md-3 col-12 col-form-label text-dark position-relative required2"><?=lang('Input.confirmpass');?></label>
                                <div class="col-xl-9 col-lg-9 col-md-9 col-12">
                                    <input type="text" class="form-control" pattern=".{6,}" id="cnewpass" name="cnewpass" required>
                                    <small class="invalid-feedback"><?=lang('Validation.matchpass');?></small>
                                </div>
                            </div>
                            <div class="row mb-5">
                        ...
                        <section class="tab-pane fade p-xl-5 p-lg-5 p-md-3 p-3" id="pass-secondary">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                                    <input type="text" class="form-control" pattern=".{6,}" id="current2ndpass" name="current2ndpass" required>
        ...
        <dd class="col-xl-12 col-lg-12 col-md-12 col-12 d-xl-none d-lg-none d-md-none">
            <div class="d-flex align-items-center">
                <i class="bx bx-chevron-left d-xl-none d-lg-none d-md-none me-2" style="cursor: pointer;" onclick="history.back();"></i>
                <h6 class="text-uppercase d-xl-none d-lg-none d-md-none d-block m-0"> <?=lang('Label.changePwd');?></h6>
            </div>
            <div class="card border-0 profileRight">
                <div class="card-body p-xl-5 p-lg-5 p-md-5 p-3">


                        <section class="tab-pane p-xl-5 p-lg-5 p-md-3 p-3" id="pass-login">
                            <?=form_open('',['class'=>'form-validation customForm chgPassForm','novalidate'=>'novalidate']);?>
                            <div class="row mb-3">
                                <label class="col-xl-3 col-lg-3 col-md-3 col-12 col-form-label text-dark position-relative required2"><?=lang('Input.currentpass');?></label>
                                <div class="col-xl-9 col-lg-9 col-md-9 col-12">
