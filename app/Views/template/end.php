        ...
        <article class="modal-content border-0">
            <div class="modal-body p-0">
                ...
                <div class="form-floating mb-3">
                    ...
                    <a class="text-decoration-none d-inline-block btn-showpass mt-2" href="javascript:void(0);" onclick="showhidepass('password')"><i class='bx bx-hide'></i></a>
...
<!-- Score Display -->
<section class="modal fade modal-gamescore" id="modal-gamescore" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal-gamescore" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<article class="modal-content border-0">
			<div class="modal-header">
				<h5 class="modal-title fs-4 fw-normal" id="scoreTitle">---</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
            <div class="modal-body">
...
const bankImages = {
    ...
    AFIN: "<?=base_url('assets/img/bankicon/affin.png');?>",
    ...
    DUIN: "<?=base_url('assets/img/bankicon/duitnow.png');?>",
    ...
    PBB: "<?=base_url('assets/img/bankicon/pbe.png');?>",
    PBBB: "<?=base_url('assets/img/bankicon/pbe.png');?>",
    ...
    CDUI: "<?=base_url('assets/img/bankchannel/dui.png');?>",
}
